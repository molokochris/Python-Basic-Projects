...
def getBirthType(thebject):
    print("the {} is {}".format(type(thebject).__name__,thebject.birthType))
...
def main():
    ...
    raptile1 = Reptile()
    print(raptile1.birthType)
    print(raptile1)

    print("Sum : {}".format(raptile1.sumAll(1, 2, 3, 4, 5,)))

    getBirthType(mammal1)
    getBirthType(raptile1)
